      ...
      <form @submit.prevent="handleSubmitLogin" class="bg-gray-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="mb-4">
          ...
          <input
            ...
            id="email" type="email" v-model="email" placeholder="Enter your email" required>
        </div>
        <div class="mb-6">
          ...
          <input
            ...
            id="password" type="password" v-model="password" placeholder="Enter your password" required>
        </div>
